...
class Engine:
    def __init__(
        ...
        # "mod.cmd" -> (module_name, handler(arg)->str)
        self._native: dict = {}
    ...
    def _build_ai(self):
        ...
        try:
            ...
            print(
                f"[engine] AI provider '{
                    self.ai_provider}' unavailable: {e}")
            return None
    ...
    def execute(self, line: str) -> dict:
        ...
        # Native (Rust-backed) commands take precedence and share the str
        # shape.
        ...
        if entry is None:
            ...
            if mod_name in self._blocked:
                return {
                    "ok": False,
                    "command": cmd,
                    "output": f"'{mod_name}' is disabled here: {
